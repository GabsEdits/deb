...
if [[ $EUID -ne 0 ]]; then
  echo "Please run sudo ./install.sh" 2>&1
  exit 1
fi
...
nala install neofetch flameshot psmisc mangohud lxappearance papirus-icon-theme lxappearance fonts-noto-color-emoji sddm -y
